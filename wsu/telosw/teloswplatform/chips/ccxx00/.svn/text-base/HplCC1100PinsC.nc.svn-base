...
implementation {
  ...
  //Modified by Gang Lu 02/04/2009, change pin configuration
  //CC1100GDO2.HplInterrupt -> HplMsp430InterruptP.Port26;
  //CC1100GDO0.HplInterrupt -> HplMsp430InterruptP.Port23;
	//This is the configuration for telosw
  CC1100GDO2.HplInterrupt -> HplMsp430InterruptP.Port14;
  CC1100GDO0.HplInterrupt -> HplMsp430InterruptP.Port13;
  ...
  //CSNM -> GeneralIOC.Port60;
	//This is the conf for telosw
  CSNM -> GeneralIOC.Port42;
	//this is the conf to test evaluation board
  ...
  //CC1100GDO0_IO -> GeneralIOC.Port23;
	//This is the conf for telosw
  CC1100GDO0_IO -> GeneralIOC.Port13;
  ...
  //CC1100GDO2_IO -> GeneralIOC.Port26;
	//This is the conf for telosw
  CC1100GDO2_IO -> GeneralIOC.Port14;
