% TODO "elsewhere"' should be replaced with the actual reference to those sections
% http:// links should be in the bibliography
% Spell check, fix errors.
...
\author{David Moss\\
		...
		Tucson, Arizona\\
		\texttt{mossmoss at gmail dot com}}  %\texttt formats the text to a typewriter style font
