...
def print_em(data):
    ...
    for i in range(0,s,6):
        try:
            ...
            print "%04.02f\t%d\t%d\t%d\t%d\t%d\t%d" % (t, data[i], data[i+1], data[i+2], data[i+3], data[i+4], data[i+5])
            #print "%04.02f\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d" % (t, data[i], data[i+1], data[i+2], data[i+3], data[i+4], data[i+5], data[i+6], data[i+7], data[i+8])
        except:
