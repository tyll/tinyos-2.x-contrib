...
/**
 * WMTP Throttling Test.
 *
 * This component tests the WMTP throttling feature.
 *
...
module TestWmtpThrottlingP {
    ...
    error_t startTest() {
        if ( TOS_NODE_ID == 0 ) {
            ...
            dbg( "TESTWMTP", "TestWmtpP: Starting throttling test.\n" );
            ...
            CS->FeatureSpecification.Throttling.Period = 1024;
