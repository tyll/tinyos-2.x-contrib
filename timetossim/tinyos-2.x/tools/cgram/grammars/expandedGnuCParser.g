...
declaratorParamaterList[boolean isFunctionDefinition, String declName] :LPAREN^   (PREPROC_DIRECTIVE)*
...
structDeclaratorList :(PREPROC_DIRECTIVE)*
...
compoundStatement[String scopeName] :LCURLY^  (PREPROC_DIRECTIVE)*
...
// inherited from grammar StdCParser
structDeclarationList :(PREPROC_DIRECTIVE)* ( structDeclaration  (PREPROC_DIRECTIVE)* )+
        ;
