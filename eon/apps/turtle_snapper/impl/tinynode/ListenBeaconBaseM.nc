...
TOS_Msg msgbuf;
	...
	command result_t IListenBeaconBase.srcStart (ListenBeaconBase_out * out)
	{
		node_out = out;
		return SUCCESS;
	}
	...
	event TOS_MsgPtr ReceiveMsg.receive (TOS_MsgPtr msg)
	{
		...
		if (g_active)
		{
			signal IListenBeaconBase.srcFired(node_out);
		}
