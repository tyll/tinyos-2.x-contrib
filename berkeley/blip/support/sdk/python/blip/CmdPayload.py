...
# This class implements a Python interface to the 'CmdPayload'
# message type.
#
...
class CmdPayload(tinyos.message.Message.Message):
    # Create a new CmdPayload of size 2.
