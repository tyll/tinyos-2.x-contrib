...
implementation {
  ...
  event void IOCFG2_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_IOCFG2, readBuffer);
    call IOCFG2_Test.done();
  }
  
  event void IOCFG1_Test.run() {
    call IOCFG1.write(CC1100_CONFIG_IOCFG1);
    call IOCFG1.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_IOCFG1, readBuffer);
  ...
  event void IOCFG0_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_IOCFG0, readBuffer);
  ...
  event void FIFOTHR_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_FIFOTHR, readBuffer);
    call FIFOTHR_Test.done();
  }
  
  event void SYNC1_Test.run() {
    call SYNC1.write(CC1100_CONFIG_SYNC1);
    call SYNC1.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_SYNC1, readBuffer);
    call SYNC1_Test.done();
  }
  
  event void SYNC0_Test.run() {
    call SYNC0.write(CC1100_CONFIG_SYNC0);
    call SYNC0.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_SYNC0, readBuffer);
    call SYNC0_Test.done();
  }
  
  event void PKTLEN_Test.run() {
    call PKTLEN.write(CC1100_CONFIG_PKTLEN);
    call PKTLEN.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_PKTLEN, readBuffer);
  ...
  event void PKTCTRL1_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_PKTCTRL1, readBuffer);
    call PKTCTRL1_Test.done();
  }
  
  event void PKTCTRL0_Test.run() {
    call PKTCTRL0.write(CC1100_CONFIG_PKTCTRL0);
    call PKTCTRL0.read(&readBuffer);
    // Top bit reserved
    assertEquals("Wrong value", CC1100_CONFIG_PKTCTRL0, (readBuffer & 0x7F));
    call PKTCTRL0_Test.done();
  }
  
  event void ADDR_Test.run() {
    call ADDR.write(CC1100_CONFIG_ADDR);
    call ADDR.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_ADDR, readBuffer);
    call ADDR_Test.done();
  }
  
  event void CHANNR_Test.run() {
    call CHANNR.write(CC1100_CONFIG_CHANNR);
    call CHANNR.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_CHANNR, readBuffer);
  ...
  event void FSCTRL1_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_FSCTRL1, (readBuffer & 0x1F));
    call FSCTRL1_Test.done();
  }
  
  event void FSCTRL0_Test.run() {
    call FSCTRL0.write(CC1100_CONFIG_FSCTRL0);
    call FSCTRL0.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_FSCTRL0, readBuffer);
  ...
  event void FREQ2_Test.run() {
    ...
    //top two bits are not writable, so mask them off
    assertEquals("Wrong value", CC1100_CONFIG_FREQ2 & 0x3F, readBuffer);
  ...
  event void FREQ1_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_FREQ1, readBuffer);
  ...
  event void FREQ0_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_FREQ0, readBuffer);
  ...
  event void MDMCFG4_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_MDMCFG4, readBuffer);
  ...
  event void MDMCFG3_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_MDMCFG3, readBuffer);
  ...
  event void MDMCFG2_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_MDMCFG2, readBuffer);
  ...
  event void MDMCFG1_Test.run() {
    ...
    // 3:2 reserved
    assertEquals("Wrong value", CC1100_CONFIG_MDMCFG1, (readBuffer & 0xF3));
  ...
  event void MDMCFG0_Test.run() {
    ...
    assertEquals("Wrong value", CC1100_CONFIG_MDMCFG0, readBuffer);
  ...
  event void DEVIATN_Test.run() {
    ...
    // Bits 7, 3 reserved
    assertEquals("Wrong value", CC1100_CONFIG_DEVIATN, (readBuffer & 0x77));
    call DEVIATN_Test.done();
  }
  
  event void MCSM2_Test.run() {
    call MCSM2.write(CC1100_CONFIG_MCSM2);
    call MCSM2.read(&readBuffer);
    // 7:5 reserved
    assertEquals("Wrong value", CC1100_CONFIG_MCSM2, (readBuffer & 0x1F));
  ...
  event void MCSM1_Test.run() {
    ...
    // 7:6 reserved
    assertEquals("Wrong value", CC1100_CONFIG_MCSM1, (readBuffer & 0x3F));
  ...
  event void MCSM0_Test.run() {
    ...
    // 7:6 reserved
    assertEquals("Wrong value", CC1100_CONFIG_MCSM0, (readBuffer & 0x3F));
    call MCSM0_Test.done();
  }
  
  event void FOCCFG_Test.run() {
    call FOCCFG.write(CC1100_CONFIG_FOCCFG);
    call FOCCFG.read(&readBuffer);
    // 7:6 reserved
    assertEquals("Wrong value", CC1100_CONFIG_FOCCFG, (readBuffer & 0x3F));
    call FOCCFG_Test.done();
  }
  
  event void BSCFG_Test.run() {
    call BSCFG.write(CC1100_CONFIG_BSCFG);
    call BSCFG.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_BSCFG, readBuffer);
    call BSCFG_Test.done();
  }
  
  event void AGCTRL2_Test.run() {
    call AGCTRL2.write(CC1100_CONFIG_AGCTRL2);
    call AGCTRL2.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_AGCTRL2, readBuffer);
    call AGCTRL2_Test.done();
  }
  
  event void AGCTRL1_Test.run() {
    call AGCTRL1.write(CC1100_CONFIG_AGCTRL1);
    call AGCTRL1.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_AGCTRL1, (readBuffer & 0x7F));
    call AGCTRL1_Test.done();
  }
  
  event void AGCTRL0_Test.run() {
    call AGCTRL0.write(CC1100_CONFIG_AGCTRL0);
    call AGCTRL0.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_AGCTRL0, readBuffer);
    call AGCTRL0_Test.done();
  }
  
  event void WOREVT1_Test.run() {
    call WOREVT1.write(CC1100_CONFIG_WOREVT1);
    call WOREVT1.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_WOREVT1, readBuffer);
    call WOREVT1_Test.done();
  }
  
  event void WOREVT0_Test.run() {
    call WOREVT0.write(CC1100_CONFIG_WOREVT0);
    call WOREVT0.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_WOREVT0, readBuffer);
    call WOREVT0_Test.done();
  }
  
  event void WORCTRL_Test.run() {
    call WORCTRL.write(CC1100_CONFIG_WORCTRL);
    call WORCTRL.read(&readBuffer);
    // Bit 2 reserved
    assertEquals("Wrong value", CC1100_CONFIG_WORCTRL, (readBuffer & 0xFB));
    call WORCTRL_Test.done();
  }
  
  event void FREND1_Test.run() {
    call FREND1.write(CC1100_CONFIG_FREND1);
    ...
    assertEquals("Wrong value", CC1100_CONFIG_FREND1, readBuffer);
    call FREND1_Test.done();
  }
  
  event void FREND0_Test.run() {
    call FREND0.write(CC1100_CONFIG_FREND0);
    call FREND0.read(&readBuffer);
    // 7:6, 3 reserved
    assertEquals("Wrong value", CC1100_CONFIG_FREND0, (readBuffer & 0x37));
    call FREND0_Test.done();
  }
  
  event void FSCAL3_Test.run() {
    call FSCAL3.write(CC1100_CONFIG_FSCAL3);
    call FSCAL3.read(&readBuffer);
    assertEquals("Wrong value", CC1100_CONFIG_FSCAL3, readBuffer);
    call FSCAL3_Test.done();
  }
  
  event void FSCAL2_Test.run() {
    call FSCAL2.write(CC1100_CONFIG_FSCAL2);
    call FSCAL2.read(&readBuffer);
    // 7:6 reserved
    assertEquals("Wrong value", CC1100_CONFIG_FSCAL2, (readBuffer & 0x3F));
    call FSCAL2_Test.done();
  }
  
  event void FSCAL1_Test.run() {
    call FSCAL1.write(CC1100_CONFIG_FSCAL1);
    call FSCAL1.read(&readBuffer);
    // 7:6 reserved
    assertEquals("Wrong value", CC1100_CONFIG_FSCAL1, (readBuffer & 0x3F));
    call FSCAL1_Test.done();
  }
  
  event void FSCAL0_Test.run() {
    call FSCAL0.write(CC1100_CONFIG_FSCAL0);
    call FSCAL0.read(&readBuffer);
    // Bit 7 reserved
    assertEquals("Wrong value", CC1100_CONFIG_FSCAL0, (readBuffer & 0x7F));
  ...
  event void RCCTRL1_Test.run() {
    ...
    // Bit 7 reserved
    assertSuccess();
    //assertEquals("Wrong value", CC1100_CONFIG_RCCTRL1, (readBuffer & 0x7F));
  ...
  event void RCCTRL0_Test.run() {
    ...
    // Bit 7 reserved
    assertSuccess();
    //assertEquals("Wrong value", CC1100_CONFIG_RCCTRL0, (readBuffer & 0x7F));
  ...
  event void PARTNUM_Test.run() {
    ...
    assertEquals("Wrong value", 0x00, readBuffer);
