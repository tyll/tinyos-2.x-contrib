...
public class OctopusCollectedMsg extends net.tinyos.message.Message {
    ...
    /** Create a new OctopusCollectedMsg of size 13. */
    ...
    /**
     * Return the value (as a long) of the field 'reading'
     */
    public long get_reading() {
        return (long)getUIntBEElement(offsetBits_reading(), 32);
    }

    /**
     * Set the value of the field 'reading'
     */
    public void set_reading(long value) {
        setUIntBEElement(offsetBits_reading(), 32, value);
    }
