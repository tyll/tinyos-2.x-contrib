...
parameterTypeList
        :       ((p2:PREPROC_DIRECTIVE	{ print( p2 );check=true; lineDir = p2.getText(); parseLine(1); })*     			parameterDeclaration 
...
compoundStatement
        :       
		#( cs:NCompoundStatement                { print( cs );  adjustWhile(compoundStatement_AST_in);tabs++;
							if(isFunction){
								isFunction=false;
