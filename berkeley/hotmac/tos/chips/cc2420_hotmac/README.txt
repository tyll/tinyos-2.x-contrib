...
=========================================================
CC2420 2.2 Notes 11/3/2011
Hotmac (A-MAC) receiver-initiated stack
Bugs to <stevedh@eecs.berkeley.edu>

Most CC2420 #defines no longer apply.  Exceptions are:

CC2420_DEF_CHANNEL set the channel for control and data.

PacketLink and PacketAcknowledgements are required and always compiled in.
Software ACK's are not recommended due to poor performance of backcast.

Useful interfaces:
       
   CC2420PowerC.PowerCycleInfo
    - get an event whenever the radio shuts down
    - tells you how long it was on for; related to power consumption

   NeighborTableC.NeighborTable
    - see who we are caching phase information for
    - pin important neighbors so they are not evicted
