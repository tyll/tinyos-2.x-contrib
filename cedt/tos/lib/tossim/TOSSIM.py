...
class EnergyEstimator(_object):
    ...
    def __repr__(self):
        ...
        return "<%s.%s; proxy of C++ EnergyEstimator instance %s>" % (self.__class__.__module__, self.__class__.__name__, strthis,)
    def __init__(self, *args):
...
_TOSSIM.EnergyEstimator_swigregister(EnergyEstimator)
