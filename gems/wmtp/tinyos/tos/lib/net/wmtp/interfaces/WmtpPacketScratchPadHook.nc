...
/**
 * Basic interface to access packet scratch pads.
 *
 * This interface allows WMTP plugins to interact with the core by accessing
 * packet scratchpads, special buffers, associated with each packet, that may be
 * used to store packet specific state information.
 *
...
interface WmtpPacketScratchPadHook {
    /**
     * Provides the packet's scratch pad.
     *
     * @param Packet The packet's queue element.
     *
     * @return The packet's scratch pad.
    **/
    command WmtpPacketScratchPad_t *GetPacketScratchPad( WmtpQueueElement_t *Packet );
}
