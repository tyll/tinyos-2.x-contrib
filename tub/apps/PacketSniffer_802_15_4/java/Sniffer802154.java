...
public class Sniffer802154 implements MessageListener
{
    MoteIF mote;
    ...
    void run() {
      ...
      mote.registerListener(new SniffRawMsg(), this);
    ...
    synchronized public void messageReceived(int dest_addr, Message msg) {
      if (msg instanceof SniffRawMsg) {
        SniffRawMsg smsg = (SniffRawMsg)msg;
        // print out payload (802.15.4 packet) hexdump
        System.out.print( smsg.get_PHR_length() + " ");
        for (int i = 0; i < smsg.get_PHR_length(); i++ ) {
          System.out.print( smsg.getElement_PSDU_buffer(i) + " ");
        }
				System.out.print("\n");
      } else if (msg instanceof SniffControlMsg) {
    ...
    public static void main(String[] args) {
  		Sniffer802154 me = new Sniffer802154();
  		me.run();
    }
}
