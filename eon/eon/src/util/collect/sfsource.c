...
void print_sent_message(const unsigned char *packet, int len)
{
	int i;
	printf("S -> ");
	for (i = 0; i < len; i++)
...
void print_recved_message(const unsigned char *packet, int len)
{
	int i;
	printf("R <- ");
	for (i = 0; i < len; i++)
