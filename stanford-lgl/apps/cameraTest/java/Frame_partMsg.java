 ...
 * This class implements a Java interface to the 'Frame_partMsg'
 * message type.
 */

public class Frame_partMsg extends net.tinyos.message.Message {
    ...
    /** Create a new Frame_partMsg of size 66. */
    public Frame_partMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new Frame_partMsg of the given data_length. */
    public Frame_partMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Frame_partMsg with the given data_length
     * and base offset.
     */
    public Frame_partMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Frame_partMsg using the given byte array
     * as backing store.
     */
    public Frame_partMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public Frame_partMsg(byte[] data, int base_offset) {
     ...
     */
    public Frame_partMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Frame_partMsg embedded in the given message
     * at the given base offset.
     */
    public Frame_partMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public Frame_partMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <Frame_partMsg> \n";
      try {
