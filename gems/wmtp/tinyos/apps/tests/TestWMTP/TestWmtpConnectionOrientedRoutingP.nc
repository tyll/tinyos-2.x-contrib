...
/**
 * WMTP Connection-Oriented Routing Test.
 *
 * This component tests the WMTP connection-oriented routing.
 *
...
module TestWmtpConnectionOrientedRoutingP {
    uses {
        interface Boot;
    ...
    error_t startTest() {
        if ( TOS_NODE_ID == 0 ) {
            ...
            dbg( "TESTWMTP", "TestWmtpP: Starting connection-oriented test.\n" );
