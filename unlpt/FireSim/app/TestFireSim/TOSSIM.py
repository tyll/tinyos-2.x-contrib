...
class FireEstimator(_object):
    ...
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, FireEstimator, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _TOSSIM.new_FireEstimator(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _TOSSIM.delete_FireEstimator
    __del__ = lambda self : None;
    def setIgnition(*args): return _TOSSIM.FireEstimator_setIgnition(*args)
    def setGrid(*args): return _TOSSIM.FireEstimator_setGrid(*args)
FireEstimator_swigregister = _TOSSIM.FireEstimator_swigregister
FireEstimator_swigregister(FireEstimator)
