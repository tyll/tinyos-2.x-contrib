...
configuration WmtpAdapterQueueP {
...
implementation {
    ...
    components new AMQueueImplP(NUM_CLIENTS), WmtpAdapterC;

    Send = AMQueueImplP;
    AMQueueImplP.AMSend -> WmtpAdapterC;
    AMQueueImplP.AMPacket -> WmtpAdapterC;
    AMQueueImplP.Packet -> WmtpAdapterC;
