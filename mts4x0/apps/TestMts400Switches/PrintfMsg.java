...
public class PrintfMsg extends net.tinyos.message.Message {
    ...
    /** Create a new PrintfMsg of size 31. */
    public PrintfMsg() {
    ...
    public static int offset_buffer(int index1) {
        int offset = 0;
        if (index1 < 0 || index1 >= 31) throw new ArrayIndexOutOfBoundsException();
        offset += 0 + index1 * 8;
        return (offset / 8);
    }
    ...
    public String getString_buffer() { 
         char carr[] = new char[Math.min(net.tinyos.message.Message.MAX_CONVERTED_STRING_LENGTH,31)];
         int i;
