...
implementation {
  ...
  event void IOCFG2_Test.run() {
    call IOCFG2.write(CC2500_CONFIG_IOCFG2);
  ...
  event void IOCFG1_Test.run() {
    call IOCFG1.write(CC2500_CONFIG_IOCFG1);
  ...
  event void IOCFG0_Test.run() {
    call IOCFG0.write(CC2500_CONFIG_IOCFG0);
  ...
  event void FIFOTHR_Test.run() {
    call FIFOTHR.write(CC2500_CONFIG_FIFOTHR);
  ...
  event void SYNC1_Test.run() {
    call SYNC1.write(CC2500_CONFIG_SYNC1);
  ...
  event void SYNC0_Test.run() {
    call SYNC0.write(CC2500_CONFIG_SYNC0);
  ...
  event void PKTLEN_Test.run() {
    call PKTLEN.write(CC2500_CONFIG_PKTLEN);
  ...
  event void PKTCTRL1_Test.run() {
    call PKTCTRL1.write(CC2500_CONFIG_PKTCTRL1);
  ...
  event void PKTCTRL0_Test.run() {
    call PKTCTRL0.write(CC2500_CONFIG_PKTCTRL0);
  ...
  event void ADDR_Test.run() {
    call ADDR.write(CC2500_CONFIG_ADDR);
  ...
  event void CHANNR_Test.run() {
    call CHANNR.write(CC2500_CONFIG_CHANNR);
  ...
  event void FSCTRL1_Test.run() {
    call FSCTRL1.write(CC2500_CONFIG_FSCTRL1);
  ...
  event void FSCTRL0_Test.run() {
    call FSCTRL0.write(CC2500_CONFIG_FSCTRL0);
  ...
  event void FREQ2_Test.run() {
    call FREQ2.write(CC2500_CONFIG_FREQ2);
    call FREQ2.read(&readBuffer);
    assertEquals("Wrong value", CC2500_CONFIG_FREQ2, readBuffer);
    call FREQ2_Test.done();
  }
  
  event void FREQ1_Test.run() {
    call FREQ1.write(CC2500_CONFIG_FREQ1);
  ...
  event void FREQ0_Test.run() {
    call FREQ0.write(CC2500_CONFIG_FREQ0);
  ...
  event void MDMCFG4_Test.run() {
    call MDMCFG4.write(CC2500_CONFIG_MDMCFG4);
  ...
  event void MDMCFG3_Test.run() {
    call MDMCFG3.write(CC2500_CONFIG_MDMCFG3);
  ...
  event void MDMCFG2_Test.run() {
    call MDMCFG2.write(CC2500_CONFIG_MDMCFG2);
  ...
  event void MDMCFG1_Test.run() {
    call MDMCFG1.write(CC2500_CONFIG_MDMCFG1);
  ...
  event void MDMCFG0_Test.run() {
    call MDMCFG0.write(CC2500_CONFIG_MDMCFG0);
  ...
  event void DEVIATN_Test.run() {
    call DEVIATN.write(CC2500_CONFIG_DEVIATN);
  ...
  event void MCSM2_Test.run() {
    call MCSM2.write(CC2500_CONFIG_MCSM2);
  ...
  event void MCSM1_Test.run() {
    call MCSM1.write(CC2500_CONFIG_MCSM1);
  ...
  event void MCSM0_Test.run() {
    call MCSM0.write(CC2500_CONFIG_MCSM0);
  ...
  event void FOCCFG_Test.run() {
    call FOCCFG.write(CC2500_CONFIG_FOCCFG);
  ...
  event void BSCFG_Test.run() {
    call BSCFG.write(CC2500_CONFIG_BSCFG);
  ...
  event void AGCTRL2_Test.run() {
    call AGCTRL2.write(CC2500_CONFIG_AGCTRL2);
  ...
  event void AGCTRL1_Test.run() {
    call AGCTRL1.write(CC2500_CONFIG_AGCTRL1);
  ...
  event void AGCTRL0_Test.run() {
    call AGCTRL0.write(CC2500_CONFIG_AGCTRL0);
  ...
  event void WOREVT1_Test.run() {
    call WOREVT1.write(CC2500_CONFIG_WOREVT1);
  ...
  event void WOREVT0_Test.run() {
    call WOREVT0.write(CC2500_CONFIG_WOREVT0);
  ...
  event void WORCTRL_Test.run() {
    call WORCTRL.write(CC2500_CONFIG_WORCTRL);
  ...
  event void FREND1_Test.run() {
    call FREND1.write(CC2500_CONFIG_FREND1);
  ...
  event void FREND0_Test.run() {
    call FREND0.write(CC2500_CONFIG_FREND0);
  ...
  event void FSCAL3_Test.run() {
    call FSCAL3.write(CC2500_CONFIG_FSCAL3);
  ...
  event void FSCAL2_Test.run() {
    call FSCAL2.write(CC2500_CONFIG_FSCAL2);
  ...
  event void FSCAL1_Test.run() {
    call FSCAL1.write(CC2500_CONFIG_FSCAL1);
  ...
  event void FSCAL0_Test.run() {
    call FSCAL0.write(CC2500_CONFIG_FSCAL0);
