...
implementation {
  ...
  event void IOCFG1_Test.run() {
    ...
    assertEquals("Wrong value", 0x2E, readBuffer);
  ...
  event void PKTCTRL0_Test.run() {
    ...
    // Top bit reserved
    assertEquals("Wrong value", 0x45, (readBuffer & 0x7F));
  ...
  event void FSCTRL1_Test.run() {
    ...
    assertEquals("Wrong value", 0x0F, (readBuffer & 0x1F));
  ...
  event void MDMCFG1_Test.run() {
    ...
    // 3:2 reserved
    assertEquals("Wrong value", 0x22, (readBuffer & 0xF3));
  ...
  event void DEVIATN_Test.run() {
    ...
    // Bits 7, 3 reserved
    assertEquals("Wrong value", 0x47, (readBuffer & 0x77));
  ...
  event void MCSM2_Test.run() {
    ...
    // 7:5 reserved
    assertEquals("Wrong value", 0x07, (readBuffer & 0x1F));
  ...
  event void MCSM1_Test.run() {
    ...
    // 7:6 reserved
    assertEquals("Wrong value", 0x30, (readBuffer & 0x3F));
  ...
  event void MCSM0_Test.run() {
    ...
    // 7:6 reserved
    assertEquals("Wrong value", 0x04, (readBuffer & 0x3F));
  ...
  event void WOREVT1_Test.run() {
    ...
    assertEquals("Wrong value", 0x87, readBuffer);
    call WOREVT1_Test.done();
  }
  
  event void WOREVT0_Test.run() {
    call WOREVT0.read(&readBuffer);
    assertEquals("Wrong value", 0x6B, readBuffer);
  ...
  event void WORCTRL_Test.run() {
    ...
    // Bit 2 reserved
    assertEquals("Wrong value", 0xF8, (readBuffer & 0xFB));
  ...
  event void FREND1_Test.run() {
    ...
    assertEquals("Wrong value", 0x56, readBuffer);
  ...
  event void FREND0_Test.run() {
    ...
    // 7:6, 3 reserved
    assertEquals("Wrong value", 0x10, (readBuffer & 0x37));
    call FREND0_Test.done();
  }
  
  event void FSCAL3_Test.run() {
    call FSCAL3.read(&readBuffer);
    assertEquals("Wrong value", 0xA9, readBuffer);
  ...
  event void FSCAL2_Test.run() {
    ...
    // 7:6 reserved
    assertEquals("Wrong value", 0x0A, (readBuffer & 0x3F));
  ...
  event void FSCAL1_Test.run() {
    ...
    // 7:6 reserved
    assertEquals("Wrong value", 0x20, (readBuffer & 0x3F));
  ...
  event void FSCAL0_Test.run() {
    ...
    // Bit 7 reserved
    assertEquals("Wrong value", 0x0D, (readBuffer & 0x7F));
  ...
  event void RCCTRL1_Test.run() {
    ...
    // Bit 7 reserved
    assertEquals("Wrong value", 0x41, (readBuffer & 0x7F));
  ...
  event void RCCTRL0_Test.run() {
    ...
    // Bit 7 reserved
    assertEquals("Wrong value", 0x0, (readBuffer & 0x7F));
    call RCCTRL0_Test.done();
  }
  
  event void FSTEST_Test.run() {
    call FSTEST.read(&readBuffer);
    assertEquals("Wrong value", 0x59, readBuffer);
