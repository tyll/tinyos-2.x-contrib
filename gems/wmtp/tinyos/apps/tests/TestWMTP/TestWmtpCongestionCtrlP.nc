...
/**
 * WMTP Congestion Control Test.
 *
 * This component tests the WMTP congestion control feature.
 *
...
module TestWmtpCongestionCtrlP {
    uses {
        interface Boot;
    ...
    error_t startTest() {
        if ( TOS_NODE_ID == 0 ) {
            ...
            dbg( "TESTWMTP", "TestWmtpP: Starting congestion control test.\n" );
