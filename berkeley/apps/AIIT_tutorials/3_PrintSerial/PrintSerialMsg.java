 ...
 * This class implements a Java interface to the 'PrintSerialMsg'
 * message type.
 */

public class PrintSerialMsg extends net.tinyos.message.Message {
    ...
    /** Create a new PrintSerialMsg of size 28. */
    public PrintSerialMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new PrintSerialMsg of the given data_length. */
    public PrintSerialMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new PrintSerialMsg with the given data_length
     * and base offset.
     */
    public PrintSerialMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new PrintSerialMsg using the given byte array
     * as backing store.
     */
    public PrintSerialMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public PrintSerialMsg(byte[] data, int base_offset) {
     ...
     */
    public PrintSerialMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new PrintSerialMsg embedded in the given message
     * at the given base offset.
     */
    public PrintSerialMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public PrintSerialMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <PrintSerialMsg> \n";
      try {
        s += "  [buffer=";
        for (int i = 0; i < 28; i++) {
